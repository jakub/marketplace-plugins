...
- **escalation pings**: a tripped valve pushes to the phone from the conductor; the stage profile for this host says what that ping binds to, including when the answer is that this host has nothing to ping with.
