...
const model = z.string().regex(MODEL_PATTERN).describe('Provider model id or alias. Claude takes an alias (sonnet, opus, fable) or a full id (claude-fable-5-1); Codex takes its own ids (gpt-6-sol). Never the charter table\'s short names.')
