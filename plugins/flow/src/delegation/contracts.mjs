...
export const ERROR_KINDS = ['AGENT_SDK_MISSING', 'APPROVAL_REQUIRED', 'APP_SERVER_ERROR', 'APP_SERVER_EXIT', 'APP_SERVER_PROTOCOL',
  'APP_SERVER_TIMEOUT', 'BAD_EFFORT', 'BAD_MODEL', 'BAD_REQUEST', 'BAD_SCHEMA', 'BAD_WORKSPACE', 'BILLING', 'CLAUDE_AUTH',
  'CLAUDE_NOT_INSTALLED', 'CLAUDE_PROTOCOL', 'CLAUDE_SDK', 'CLAUDE_STARTUP', 'CLAUDE_STARTUP_TIMEOUT', 'CLAUDE_TURN', 'CLAUDE_VERSION',
  'CODEX_AUTH', 'CODEX_NOT_INSTALLED', 'CODEX_TOO_OLD', 'CODEX_TURN', 'CODEX_VERSION', 'CONTAINMENT_UNAVAILABLE', 'CONTROL_UNSUPPORTED',
  'DATABASE_NEWER', 'EMPTY_OUTPUT', 'GIT_REF', 'INTERNAL', 'INTERRUPTED', 'JOB_NOT_FOUND', 'JOB_QUARANTINED', 'JOB_STATE',
  'LIMIT_UNSUPPORTED', 'MAX_BUDGET', 'MAX_TURNS', 'MCP_ISOLATION', 'MODEL_MISMATCH', 'NESTED_DELEGATION', 'NO_ROOTS', 'NO_THREAD',
  'NO_WORKSPACE', 'OUTSIDE_ROOTS', 'OVERLOADED', 'PERMISSION_PROFILE', 'PROVIDER_QUARANTINED', 'RATE_LIMIT', 'RECOVERY_UNKNOWN',
  'REFUSAL', 'ROUTE_DENIED', 'SAME_FAMILY', 'SANDBOX_UNAVAILABLE', 'SCHEMA_OUTPUT', 'STALL', 'STORE_UPGRADE_BLOCKED', 'TIMEOUT',
  'UNKNOWN_JOB', 'UNKNOWN_TURN', 'UNSUPPORTED_HOST', 'WORKER_EXIT', 'WORKER_IDENTITY', 'WORKER_SPAWN_FAILED', 'WORKSPACE_BUSY']
